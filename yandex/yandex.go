...
func Get(ctx context.Context, search string) (res entity.ResponseStruct, err error) {
	cli := http.Client{}
	var req *http.Request
	req, err = http.NewRequestWithContext(ctx, http.MethodGet, fmt.Sprintf(baseYandexURL, search), nil)
	if err != nil {
		return
	}
	...
	res = parseYandexResponse(bt)
	return
}

func parseYandexResponse(response []byte) (res entity.ResponseStruct) {
	res = entity.ResponseStruct{Items: make([]entity.ResponseItem, 0)}
	...
	items.Each(func(i int, selection *goquery.Selection) {
		...
		if !selection.Is("div.Label") && !aExists && !selection.Is("span.organic__advLabel") && cidExists {
			...
			if link != nil {
				...
				res.Items = append(res.Items, entity.ResponseItem{
